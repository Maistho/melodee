    ...
    : IAlbumImageSearchEnginePlugin, IArtistImageSearchEnginePlugin
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var requestUri =
            $"https://api.deezer.com/search/album?q=\"{Uri.EscapeDataString(query.Name.Trim())}\"&output=json&limit={maxResults}";
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var httpClient = httpClientFactory.CreateClient();
        var requestUri =
            $"https://api.deezer.com/search/artist?q=\"{Uri.EscapeDataString(query.Name.Trim())}\"&output=json&limit=1&order=RANKING";
