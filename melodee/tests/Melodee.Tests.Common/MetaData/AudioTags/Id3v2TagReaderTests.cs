...
public class Id3v2TagReaderTests
{
    ...
    public Id3v2TagReaderTests(ITestOutputHelper output)
    {
    ...
    public async Task Should_Handle_Very_Long_Tag_Values()
    {
        ...
        var longString = new string('A', 10000); // 10,000 'A' characters
    ...
    public async Task Should_Fail_Reading_Non_Existent_File()
    {
        ...
        var nonExistentFilePath = Path.Combine(_testOutputPath, "does-not-exist.mp3");
    ...
    public async Task Should_Fail_Reading_Invalid_File_Format()
    {
        ...
        var filePath = Path.Combine(_testOutputPath, "fake-mp3-file.mp3");
    ...
    public async Task Should_Handle_Zero_Byte_Files()
    {
        ...
        var filePath = Path.Combine(_testOutputPath, "empty.mp3");
    ...
    public async Task Should_Handle_Corrupted_Tag_Data()
    {
        ...
        try
        {
            ...
            using (var stream = new FileStream(filePath, FileMode.Open, FileAccess.ReadWrite))
            {
                ...
                var corruption = new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };
