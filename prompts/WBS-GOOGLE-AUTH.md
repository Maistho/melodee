...
The following canonical error codes must be used by auth-related endpoints and surfaced in `docs/openapi.yaml` so clients can implement deterministic handling:
