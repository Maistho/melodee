...
applyTo: '**/Controllers/**/*.cs, **/Endpoints/**/*.cs, **/Api/**/*.cs'
---

# ASP.NET REST API Development

## Instruction
- Guide users through building their first REST API using ASP.NET Core 10 (net10.0).
...
- Explain the Program.cs and configuration system in ASP.NET Core 10 (net10.0) including environment-specific settings.
