...
This document outlines the feature gaps in Melodee's podcast support by comparing it to other open-source music streaming projects that include podcast functionality. The analysis is based on a review of popular open-source projects such as Ampache, Subsonic (and its forks like Airsonic and Navidrome), and Funkwhale, which integrate podcast management into their music libraries. These projects were selected because they are self-hosted, open-source music servers similar in scope to Melodee, and explicitly support podcasts alongside music streaming.
...
### 2. Subsonic (and Forks: Airsonic, Navidrome)
Subsonic is a free, web-based media streamer with a rich ecosystem of clients. Podcast support is built-in since v4.7, with improvements in forks like Airsonic (advanced UI) and Navidrome (modern REST API).
...
### 1. RSS Feed Subscription and Parsing
   ...
   - **Prevalence in Researched Projects**: Universal (Ampache, Subsonic, Funkwhale).
...
### 2. Automatic Episode Downloading and Sync
   ...
   - **Prevalence in Researched Projects**: Core in all (e.g., Subsonic's partial sync).
...
### 3. Dedicated Episode Management UI and API
   ...
   - **Prevalence in Researched Projects**: All have dedicated tabs (e.g., Ampache's podcast view).
...
### 4. Podcast-Specific Metadata and Display
   ...
   - **Prevalence in Researched Projects**: Full support (e.g., Funkwhale's transcripts).
...
### 5. Playback Enhancements for Episodes
   ...
   - **Prevalence in Researched Projects**: Subsonic excels here with speed controls.
...
### 6. Search, Filtering, and Recommendations for Podcasts
   ...
   - **Prevalence in Researched Projects**: All support (e.g., Navidrome's filters).
...
### 7. Offline Download and Export
   ...
   - **Prevalence in Researched Projects**: Standard (e.g., Airsonic's queue).
...
### 8. Multi-User and Sharing Features
   ...
   - **Prevalence in Researched Projects**: Subsonic's user-specific libs.
...
### 9. Integration with Existing Systems
   ...
   - **Prevalence in Researched Projects**: Key for Subsonic ecosystem.
