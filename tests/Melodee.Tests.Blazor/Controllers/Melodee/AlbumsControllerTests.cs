...
public class AlbumsControllerTests
{
    ...
    #region Starred Albums Endpoint Tests

    [Fact]
    public void StarredAlbumsAsync_HasCorrectRouteAttribute()
    {
        // Arrange
        var method = typeof(AlbumsController).GetMethod(nameof(AlbumsController.StarredAlbumsAsync));
    ...
    [Fact]
    public void StarredAlbumsAsync_HasHttpGetAttribute()
    {
        // Arrange
        var method = typeof(AlbumsController).GetMethod(nameof(AlbumsController.StarredAlbumsAsync));
    ...
    [Fact]
    public void StarredAlbumsAsync_HasCorrectParameters()
    {
        // Arrange
        var method = typeof(AlbumsController).GetMethod(nameof(AlbumsController.StarredAlbumsAsync));
    ...
    [Fact]
    public void StarredAlbumsAsync_HasCorrectDefaultValues()
    {
        // Arrange
        var method = typeof(AlbumsController).GetMethod(nameof(AlbumsController.StarredAlbumsAsync));
    ...
    [Fact]
    public void StarredAlbumsAsync_ReturnsTaskOfIActionResult()
    {
        // Arrange
        var method = typeof(AlbumsController).GetMethod(nameof(AlbumsController.StarredAlbumsAsync));
    ...
    #region Hated Albums Endpoint Tests

    [Fact]
    public void HatedAlbumsAsync_HasCorrectRouteAttribute()
    {
        // Arrange
        var method = typeof(AlbumsController).GetMethod(nameof(AlbumsController.HatedAlbumsAsync));
    ...
    [Fact]
    public void HatedAlbumsAsync_HasHttpGetAttribute()
    {
        // Arrange
        var method = typeof(AlbumsController).GetMethod(nameof(AlbumsController.HatedAlbumsAsync));
    ...
    [Fact]
    public void HatedAlbumsAsync_HasCorrectParameters()
    {
        // Arrange
        var method = typeof(AlbumsController).GetMethod(nameof(AlbumsController.HatedAlbumsAsync));
    ...
    [Fact]
    public void HatedAlbumsAsync_HasCorrectDefaultValues()
    {
        // Arrange
        var method = typeof(AlbumsController).GetMethod(nameof(AlbumsController.HatedAlbumsAsync));
    ...
    [Fact]
    public void HatedAlbumsAsync_ReturnsTaskOfIActionResult()
    {
        // Arrange
        var method = typeof(AlbumsController).GetMethod(nameof(AlbumsController.HatedAlbumsAsync));
    ...
    #region Top Rated Albums Endpoint Tests

    [Fact]
    public void TopRatedAlbumsAsync_HasCorrectRouteAttribute()
    {
        // Arrange
        var method = typeof(AlbumsController).GetMethod(nameof(AlbumsController.TopRatedAlbumsAsync));
    ...
    [Fact]
    public void TopRatedAlbumsAsync_HasHttpGetAttribute()
    {
        // Arrange
        var method = typeof(AlbumsController).GetMethod(nameof(AlbumsController.TopRatedAlbumsAsync));
    ...
    [Fact]
    public void TopRatedAlbumsAsync_HasCorrectParameters()
    {
        // Arrange
        var method = typeof(AlbumsController).GetMethod(nameof(AlbumsController.TopRatedAlbumsAsync));
    ...
    [Fact]
    public void TopRatedAlbumsAsync_HasCorrectDefaultValues()
    {
        // Arrange
        var method = typeof(AlbumsController).GetMethod(nameof(AlbumsController.TopRatedAlbumsAsync));
    ...
    [Fact]
    public void TopRatedAlbumsAsync_ReturnsTaskOfIActionResult()
    {
        // Arrange
        var method = typeof(AlbumsController).GetMethod(nameof(AlbumsController.TopRatedAlbumsAsync));
