...
/// <summary>
/// Tests for Data/Users.razor component localization.
/// Verifies that all resource keys used in the Users component exist and return non-empty values.
/// </summary>
public class UsersLocalizationTests
{
    ...
    [Theory]
    [InlineData("Users.PageTitle")]
    [InlineData("Users.Header")]
    [InlineData("Users.Add")]
    [InlineData("Users.Delete")]
    public void Users_ResourceKeys_Exist(string resourceKey)
    {
        // Act
    ...
    [Fact]
    public void Users_AllResourceKeys_ReturnNonEmptyValues()
    {
        // Arrange
        var allKeys = new[]
        {
    ...
    [Fact]
    public void Users_ResourceKeyCount_ShouldBe4()
    {
        // Arrange
        var expectedCount = 4;
        var allKeys = new[]
        ...
        // Assert
        allKeys.Length.Should().Be(expectedCount, $"Users page should have exactly {expectedCount} resource keys");
    }
